...
import { Link, Separator } from '@tszhong0411/ui'
  ...
  return (
    ...
    >
      ...
      <Link href='/' className='flex items-center justify-center gap-1'>
        ...
        >
          <path
            d='M25.5 80.75H38.25V55.25H63.75V80.75H76.5V42.5L51 23.375L25.5 42.5V80.75ZM17 89.25V38.25L51 12.75L85 38.25V89.25H55.25V63.75H46.75V89.25H17Z'
            fill='#C7C7C7'
          />
        </svg>
      </Link>
